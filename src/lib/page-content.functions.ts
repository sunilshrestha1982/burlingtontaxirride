  ...
  .handler(async ({ context, data }) => {
    ...
    const { data: row, error } = await (context.supabase as any)
      ...
      .insert({
        ...
        page_type: "location",
        sort_order: 500,
        meta_title: `${town}, VT Airport Taxi Shuttle, BTV Airport Transfers, 24-7`,
        meta_description: `Book a 24-7 taxi shuttle from Burlington Airport (BTV) to ${town}, VT with Burlington VT Taxi Ride. Enjoy reliable airport transfers, comfortable rides, and upfront fixed rates. Call 802-448-0707.`,
