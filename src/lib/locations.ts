...
export const LOCATIONS: Location[] = [
  ...
  { slug: "burlington-warren-waitsfield-taxi", label: "Burlington to Warren / Waitsfield", title: "Burlington to Warren / Waitsfield, VT", destination: "Warren & Waitsfield (Mad River Valley)", drive: "~1 hr", image: destinationLandscapeImage("burlington-warren-waitsfield-taxi", "Warren and Waitsfield, Vermont", "mad-river-valley"),
  ...
  { slug: "burlington-swanton-taxi", label: "Burlington to Swanton", title: "Burlington to Swanton, VT", destination: "Swanton, VT", drive: "~45 min", image: destinationLandscapeImage("burlington-swanton-taxi", "Swanton, Vermont", "swanton"),
  ...
  { slug: "burlington-newport-taxi", label: "Burlington to Newport", title: "Burlington to Newport, VT", destination: "Newport, VT", drive: "~1 hr 30 min", image: destinationLandscapeImage("burlington-newport-taxi", "Newport, Vermont", "lake-memphremagog"),
