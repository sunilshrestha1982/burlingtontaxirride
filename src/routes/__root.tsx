...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://burlingtontaxirride.taxi-webdesign.com/og-image.jpg" },
      { property: "og:url", content: "https://burlingtontaxirride.taxi-webdesign.com" },
      ...
      { name: "twitter:image", content: "https://burlingtontaxirride.taxi-webdesign.com/og-image.jpg" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://burlingtontaxirride.taxi-webdesign.com",
          logo: "https://burlingtontaxirride.taxi-webdesign.com/favicon.png",
