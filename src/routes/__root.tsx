...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.burlingtonvttaxirride.com/og-image.jpg" },
      { property: "og:url", content: "https://www.burlingtonvttaxirride.com" },
      ...
      { name: "twitter:image", content: "https://www.burlingtonvttaxirride.com/og-image.jpg" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          email: "burlingtonvttaxirride@gmail.com",
          address: {
            "@type": "PostalAddress",
          ...
          priceRange: "$$",
          sameAs: [
            "https://www.burlingtonvttaxirride.com",
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebSite",
          "@id": "https://www.burlingtonvttaxirride.com/#website",
          name: "Burlington VT Taxi Ride",
          url: "https://www.burlingtonvttaxirride.com",
          potentialAction: {
            "@type": "SearchAction",
            target: "https://www.burlingtonvttaxirride.com/?search={search_term_string}",
