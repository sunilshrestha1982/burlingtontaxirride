...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.burlingtonvttaxiride.com/og-image.jpg" },
      { property: "og:url", content: "https://www.burlingtonvttaxiride.com" },
      ...
      { name: "twitter:image", content: "https://www.burlingtonvttaxiride.com/og-image.jpg" },
    ],
    links: [
